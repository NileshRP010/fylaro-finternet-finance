...
contract PaymentTracker is ReentrancyGuard, AccessControl {
    ...
    function createPaymentSchedule(
        ...
        // For ERC1155 tokens, we'll need to handle investors differently
        // For now, create empty arrays and update them later if needed
     ...
     * @param invoiceId The ID of the invoice
     * @return expectedAmount The expected payment amount
     ...
     * @return settled Whether it's settled
     */
