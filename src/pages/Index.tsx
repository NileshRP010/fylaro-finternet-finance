...
const Index = () => {
  ...
  const features = [
    {
      ...
      description:
        "Cryptographically verified invoice ownership with advanced fraud detection and blockchain security",
    },
    {
      icon: Globe,
      title: "Global Liquidity Pool",
      description:
        "Access worldwide investors through our unified ledger infrastructure and cross-border settlement",
    },
    {
      icon: Zap,
      title: "Instant Settlement",
      description:
        "Automated payments with real-time tracking and immediate fund transfer capabilities",
    },
    {
      icon: TrendingUp,
      title: "AI Credit Scoring",
      description:
        "Advanced machine learning algorithms provide transparent ratings based on verifiable data",
    },
  ];
  ...
  const marketData = [
    { name: "Trade Finance", apy: "12.5%", volume: "$45M", trend: "up" },
    { name: "Supply Chain Finance", apy: "10.8%", volume: "$32M", trend: "up" },
    { name: "Working Capital", apy: "14.2%", volume: "$28M", trend: "up" },
    { name: "Export Finance", apy: "11.3%", volume: "$22M", trend: "down" },
  ];
          ...
          <div className="max-w-6xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-xl lg:text-2xl text-gray-200 mb-12 max-w-4xl mx-auto leading-relaxed drop-shadow-lg">
                Transform your receivables into instant liquidity through our
                advanced tokenization platform. Connect with global investors
                and unlock working capital with unprecedented speed and
                transparency.
              </p>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
              {stats.map((stat, index) => (
                <Card
                  key={index}
                  className="glass-card hover:highlight-border transition-smooth backdrop-blur-md bg-card/80 border-white/10"
                >
      ...
      <section className="py-20">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-3xl mx-auto">
              Experience cutting-edge financial technology with
              institutional-grade security and global accessibility powered by
              the Finternet.
            </p>
          </div>
            ...
            <Card className="glass-card hover:highlight-border transition-smooth group backdrop-blur-lg bg-card/20 border-white/10">
              ...
              <CardContent>
                <p className="text-gray-300 text-lg leading-relaxed">
                  ...
                  Finternet's unified ledger technology for global
                  accessibility.
                </p>
      ...
      <section className="py-20 bg-gray-900 relative overflow-hidden">
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-300 max-w-3xl mx-auto">
              Real-time performance across finance sectors with live data flow
              visualization showing global invoice finance activity and
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 max-w-6xl mx-auto">
            {marketData.map((sector, index) => (
              <Card
                key={index}
                className="glass-card hover:highlight-border transition-smooth group backdrop-blur-lg bg-card/20 border-white/10"
              >
            ...
            {[
              {
                ...
                title: "Upload & Verify",
                description:
                  "Submit your invoice with automated KYC verification and AI-powered fraud detection systems",
                icon: FileText,
              },
              {
                step: "02",
                ...
                description:
                  "Your tokenized invoice enters our global marketplace where institutional investors compete for the best rates",
                icon: TrendingUp,
              },
              {
                step: "03",
                ...
                description:
                  "Receive immediate working capital with automated settlement and real-time payment tracking",
                icon: Zap,
              },
            ].map((item, index) => (
              <Card
                key={index}
                className="glass-card text-center hover:highlight-border transition-smooth group"
              >
                <CardContent className="p-8">
          ...
          <Card className="glass-card highlight-border max-w-4xl mx-auto">
            <CardContent className="text-center p-12 lg:p-16">
              ...
              <p className="text-xl text-muted-foreground mb-12 max-w-3xl mx-auto leading-relaxed">
                Join thousands of businesses and institutional investors already
                leveraging Fylaro's advanced invoice financing platform to
                unlock global financial opportunities.
              </p>
              <div className="flex flex-col sm:flex-row gap-6 justify-center">
                <Button
                  size="lg"
          ...
          <div className="grid lg:grid-cols-5 gap-12 mb-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-muted-foreground mb-6 max-w-md">
                The world's most advanced invoice financing platform, powered by
                Finternet technology and trusted by industry leaders globally.
              </p>
              <Button className="glow" onClick={() => navigate("/dashboard")}>
                Get Started Today
